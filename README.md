...
- Thank you to 'Faris' (Slack community) for inspiration with regards to the 4x overlapping grid methodology and the start_game() logic - it was from your function on Slack that I worked backwards in creating my structure!
- Thank you to my mentor Martina, for offering me timely guidance right up until my deadline and for looking at my code along the way.
